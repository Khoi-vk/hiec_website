                    ...
                    {data.history.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="relative z-10 grid size-12 shrink-0 place-items-center rounded-full border-2 border-primary bg-background text-xs font-mono font-bold text-primary shadow-[0_0_12px_rgba(6,182,212,0.3)] transition-transform group-hover:scale-110 md:size-14 md:text-sm">
                            {item.year}
                          </span>
