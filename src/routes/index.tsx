...
const departments = [
  {
    ...
    text: "Định hình hướng đi, nghiên cứu cơ hội và biến tầm nhìn HIEC thành những chương trình có mục tiêu rõ ràng.",
    icon: Network,
  },
  {
    code: "02",
    title: "Ban Truyền thông",
    text: "Kể câu chuyện HIEC bằng nội dung, hình ảnh và những chiến dịch khiến cộng đồng muốn cùng tham gia.",
    icon: Megaphone,
  },
  {
    code: "03",
    title: "Ban Đối ngoại",
    text: "Mở rộng mạng lưới mentor, doanh nghiệp và đối tác để mỗi thành viên có thêm một cánh cửa bước ra thế giới.",
    icon: BriefcaseBusiness,
  },
  {
    code: "04",
    title: "Ban Nhân sự Sự kiện",
    text: "Xây văn hóa nội bộ, chăm sóc con người và tạo ra những trải nghiệm sự kiện đáng nhớ.",
    icon: Users,
  },
];
  ...
  head: () => ({
    meta: [
      { title: "HIEC — Câu lạc bộ Sáng tạo & Khởi nghiệp HUST" },
      {
        name: "description",
        content:
          "HIEC là cộng đồng sinh viên học bằng cách làm, kết nối bằng giá trị và tạo tác động thật.",
      },
    ],
  }),
  component: HomePage,
  ...
  return (
    <PublicLayout>
      <main>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.88fr_1.12fr]">
            <div className="relative z-10 animate-fade-up">
              ...
              <h1 className="max-w-3xl font-sans text-5xl font-bold leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:text-7xl">
                Khởi nguồn sáng tạo,{" "}
                <span className="text-primary-deep dark:text-primary">Dẫn lối thành công</span>
              </h1>
              <p className="mt-7 max-w-xl text-base leading-8 text-muted-foreground sm:text-lg">
                Câu lạc bộ Sáng tạo & Khởi nghiệp HUST — nơi những người trẻ học bằng cách làm, kết
                nối bằng giá trị và cùng nhau tạo ra điều đáng tự hào.
              </p>
              <div className="mt-9 flex flex-wrap gap-3">
                ...
                <Button asChild size="lg" variant="outline" className="rounded-full px-7">
                  <a href="#lich-su">
                    Khám phá câu chuyện <ArrowDownRight className="ml-2 size-4" />
                  </a>
                </Button>
              </div>
        ...
        <section
          id="lich-su"
          className="border-b border-border bg-card px-5 py-20 lg:px-8 lg:py-28"
        >
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
              <div>
                ...
                <h2 className="mt-4 max-w-md text-4xl font-black leading-tight sm:text-5xl">
                  Mỗi chặng đường là một lần trưởng thành.
                </h2>
                <p className="mt-6 max-w-sm leading-7 text-muted-foreground">
                  Từ một nhóm sinh viên có chung sự tò mò, HIEC lớn lên nhờ những người dám bắt đầu,
                  dám thử và dám làm lại.
                </p>
              </div>
              <div className="grid gap-0 border-l border-border">
                {history.map((item, index) => (
                  <article
                    key={item.year}
                    className="group relative border-b border-border px-7 py-6 last:border-b-0 sm:grid sm:grid-cols-[8rem_1fr] sm:gap-4"
                  >
                    <span className="absolute -left-1.25 top-8 size-2.5 rounded-full bg-primary ring-8 ring-card" />
                    <p className="text-2xl font-black text-primary-deep dark:text-primary">
                      {item.year}
                    </p>
                    <div>
                      <h3 className="text-xl font-black group-hover:text-primary-deep dark:group-hover:text-primary">
                        {item.title}
                      </h3>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-wrap items-end justify-between gap-6">
              ...
              <p className="max-w-sm text-sm leading-7 text-muted-foreground">
                Mỗi ban là một mảnh ghép độc lập, nhưng cùng vận hành để HIEC trở thành một hệ sinh
                thái học tập và hành động.
              </p>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              {departments.map((department) => {
                ...
                return (
                  <article
                    key={department.code}
                    className="group rounded-[2rem] border border-border bg-card p-7 transition-all hover:-translate-y-1 hover:border-primary hover:shadow-elevated"
                  >
                    <div className="flex items-start justify-between">
                      <span className="text-sm font-black text-primary-deep dark:text-primary">
                        {department.code}
                      </span>
                      <span className="grid size-11 place-items-center rounded-2xl bg-primary/20 text-primary-deep dark:text-primary">
                        <Icon className="size-5" />
                      </span>
                    </div>
                    <h3 className="mt-9 max-w-xs text-2xl font-black leading-tight">
                      {department.title}
                    </h3>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 rounded-[2rem] border border-border bg-primary/20 p-8 sm:p-12 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-2xl text-4xl font-black leading-tight sm:text-6xl">
                <span className="sm:whitespace-nowrap">Ý tưởng thành tiền thật</span>
                <br />
                Gia nhập HIEC ngay!
              </h2>
              <p className="mt-5 max-w-xl text-muted-foreground">
                Nếu bạn muốn thử sức trong một môi trường nhiều năng lượng, HIEC đang chờ bạn.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Button asChild size="lg" variant="outline" className="rounded-full">
                <a href={`mailto:${contactInfo.email}`}>
                  <Mail className="mr-2 size-4" /> Liên hệ
                </a>
              </Button>
            </div>
          </div>
