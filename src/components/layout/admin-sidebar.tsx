...
const navItems = [
  ...
  { title: "Chỉnh sửa Trang chủ", url: "/admin/static-content", icon: Settings2 },
  ...
  { title: "Giao diện thành viên", url: "/admin/member-layout", icon: Layers },
] as const;
        ...
        <div className="flex h-24 items-center px-4 overflow-hidden mb-2">
          <HiecLogo
            ...
            className={cn(
              ...
              collapsed ? "scale-75 -ml-2" : "scale-100",
            )}
          />
        </div>
